...
<body>
                ...
                <tr>
                    ...
                    <td>
                        <select name="sandwich">
                            ...
                            <option value="이탈리안비엠티">이탈리안비엠티</option>
                            <option value="터키베이컨아보카도">터키베이컨아보카도</option>
                            <option value="로티세리바베큐치킨">로티세리바베큐치킨</option>
                            <option value="치즈N스테이크">치즈N스테이크</option>
                        </select>
                    </td>
                </tr>
                <tr>
    ...
    <hr>
    <br>
    <a href="/Subway/orderList.sandwich">주문내역 보기</a>
